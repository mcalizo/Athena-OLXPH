...
features=AdSenseListing-AdsenseDetails-AudienceSegments-AdUnits
featuretags=@adsenselisting,@adsensedetails,@audienceSegments,@adUnits
ec2PublicIP=52.221.227.148
