...
features=SellForm
featuretags=@sellCiProd
ec2PublicIP=54.254.232.210
...
docker cp $DIR/athena-olxph/imgs/playstation.jpeg athena-selenium-0-chrome-debug-2:/tmp/playstation.jpeg
docker cp $DIR/athena-olxph/imgs/playstation2.jpeg athena-selenium-0-chrome-debug-2:/tmp/playstation2.jpeg
docker cp $DIR/athena-olxph/imgs/playstation.jpeg athena-selenium-0-chrome-debug-3:/tmp/playstation.jpeg
docker cp $DIR/athena-olxph/imgs/playstation2.jpeg athena-selenium-0-chrome-debug-3:/tmp/playstation2.jpeg
